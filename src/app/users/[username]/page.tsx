    ...
    <div className="">
      <Breadcrumb>
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbPage>Louie Kim</BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
      {/* CONTAINER */}
        ...
        <div className="w-full xl:w-1/3 space-y-6">
          ...
          <div className="bg-primary-foreground p-4 rounded-lg">
            <div className="flex items-center justify-between">
              ...
              <Sheet>
                {/* aschild: <button><button>...</button></button> -> 버튼 안에 버튼 중첩 방지*/}
                <SheetTrigger asChild>
                  <Button className="text-sm font-bold">Edit User</Button>
                </SheetTrigger>
                {/*  */}
                <EditUser />
              </Sheet>
            ...
            <div className="space-y-4 mt-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="">+1 234 56678</span>
              </div>
              <div className="flex items-center gap-2">
